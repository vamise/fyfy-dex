        ...
        <Row>
          <Col
            ...
            style={{
              ...
              textAlign: 'center',
              border: 'transparent',
              borderBottom: side === 'buy' ? '2px solid #1083e8' : '2px solid #000e26',
              background: 'transparent',
              fontSize: 14,
              fontStyle: 'normal',
              fontWeight: 600,
              color: side === 'buy' ? '#f0f0f0' : 'rgba(241, 241, 242, 0.5)',
              padding: '12px 0 0 0'
            }}
          >
            BUY
          ...
          <Col
            ...
            style={{
              ...
              textAlign: 'center',
              border: 'transparent',
              borderBottom: side === 'sell' ? '2px solid #1083e8' : '2px solid #000e26',
              background: 'transparent',
              fontSize: 14,
              fontStyle: 'normal',
              fontWeight: 600,
              color: side === 'sell' ? '#f0f0f0' : 'rgba(241, 241, 242, 0.5)',
              padding: '12px 0 0 0'
            }}
          >
            SELL
        ...
        >
          ...
          <div style={{ marginTop: 25}}>
            ...
            <Input
              type="number"
              bordered={false}
              style={{ textAlign: 'right', paddingBottom: 8, height: 47, background: '#000e26', borderRadius: 4, }}
              suffix={
          ...
          <Row style={{ paddingTop: 8}}>
            ...
            <Col span={6} style={{
              ...
              />
                <div style={{ display: 'inline-block', fontSize: 10, color: '#e3e3e3', paddingLeft: 4 }}>POST</div>
            </Col>
            <Col span={6} style={{
              paddingTop: 10,
              paddingLeft: 10,
              ...
              />
              <div style={{ display: 'inline-block', fontSize: 10, color: '#e3e3e3', paddingLeft: 4 }}>IOC</div>
            </Col>
          </Row>
